...
from src.data.ate.linear_pv import generate_test_linear_pv, generate_train_linear_pv
from src.data.ate.exponential_pv import generate_test_exponential_pv, generate_train_exponential_pv
from src.data.ate.cosine_pv import generate_test_cosine_pv, generate_train_cosine_pv
from src.data.ate.mastourie_pv import generate_test_mastourie_pv, generate_train_mastourie_pv
...
def generate_train_data_ate(data_config: Dict[str, Any], rand_seed: int) -> PVTrainDataSet:
    ...
    if data_name == "demand":
        ...
        return generate_train_linear_pv(seed=rand_seed, **data_config)
    elif data_name == "exponential":
        return generate_train_exponential_pv(seed=rand_seed, **data_config)
    elif data_name == "cosine":
        return generate_train_cosine_pv(seed=rand_seed, **data_config)
    elif data_name == "mastourie":
        return generate_train_mastourie_pv(seed=rand_seed, **data_config)
...
def generate_test_data_ate(data_config: Dict[str, Any]) -> Optional[Union[PVTestDataSet, RHCTestDataSet]]:
    ...
    if data_name == "demand":
        ...
        return generate_test_linear_pv(**data_config)
    elif data_name == "exponential":
        return generate_test_exponential_pv(**data_config)
    elif data_name == "cosine":
        return generate_test_cosine_pv(**data_config)
    elif data_name == "mastourie":
        return generate_test_mastourie_pv(**data_config)
    elif data_name == "dsprite":
